...
function TestimonialCard({
  ...
  content = "Tuyệt vời quá! 🔥 Tôi thực sự yêu thích những gì đội ngũ đang xây dựng. Không thể chờ để thấy những gì tiếp theo!",
  date = "5 Tháng 1, 2026",
  verified = true,
  likes = 142,
  retweets = 23,
  ...
  const defaultCards: TestimonialCardProps[] = [
    {
      ...
      handle: "@linhdesigner",
      content: "Phong cách thiết kế tuyệt vời! Miyu Studio đã tạo ra bộ nhận diện thương hiệu hoàn hảo cho dự án của chúng tôi. 🎨✨",
      date: "3 Tháng 1, 2026",
      verified: true,
      likes: 42,
      retweets: 8,
    ...
    },
    {
      ...
      username: "Minh Trần",
      handle: "@minhtran_photo",
      content: "Những bức ảnh chân dung tuyệt đẹp! Kỹ thuật ánh sáng và góc chụp rất chuyên nghiệp. Highly recommended! 📸",
      date: "2 Tháng 1, 2026",
      verified: true,
      likes: 28,
      retweets: 5,
    ...
    },
    {
      ...
      username: "Hương Phạm",
      handle: "@huongart",
      content: "Tác phẩm hội họa tuyệt đẹp với màu sắc sống động và cảm xúc sâu sắc. Mỗi bức tranh đều là một câu chuyện riêng. 🎨💫",
      date: "1 Tháng 1, 2026",
      verified: true,
      likes: 156,
      retweets: 23,
...
export { TestimonialCard, Testimonials, TestimonialCardComponent };
