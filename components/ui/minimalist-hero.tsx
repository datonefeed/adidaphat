    ...
    >
      ...
      <header className="z-50 flex w-full max-w-7xl items-center justify-between relative">
        ...
        <div className="hidden items-center space-x-8 md:flex">
          ...
          {themeToggle && <div className="ml-4">{themeToggle}</div>}
        </div>
        <motion.button
          initial={{ opacity: 0, x: 20 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.5 }}
          className="flex items-center justify-center md:hidden z-50 relative"
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="flex h-full flex-col items-center justify-center space-y-8">
              ...
              {themeToggle && <div className="mt-8">{themeToggle}</div>}
            </div>
          </motion.div>
        )}
      </AnimatePresence>
